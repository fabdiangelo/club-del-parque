...
import bgImg from "../assets/CanchasTenisPadel/3.webp";
...
export default function TemporadasPage() {
  ...
  const onSubmit = async (e) => {
    ...
    if (!ack) {
      alert(
        "Debes confirmar que entiendes que las temporadas no se pueden eliminar."
      );
      return;
    }
  ...
  return (
    <div
      className="relative min-h-screen w-full text-slate-900 overflow-hidden"
      style={{
    ...
    >
      {/* Light overlay + blur to keep content readable */}
            ...
            >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-yellow-800">
                      Atención: las temporadas no se pueden eliminar una vez
                      creadas.
                    </p>
                    <p className="text-slate-700 mt-1">
                      Revisa cuidadosamente el <strong>nombre</strong> y las{" "}
                      <strong>fechas de inicio y fin</strong> antes de
                      confirmar.
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-4 flex items-center gap-3 flex-wrap">
                <button
                  ...
                  title={
                    !ack ? "Debes aceptar la advertencia" : undefined
                  }
                >
                  {loading ? (
                    "Creando…"
                    ...
                    <>
                      <CalendarPlus className="w-5 h-5" /> Crear
                    </>
                  )}
                </button>
                ...
                <table className="w-full text-left text-slate-900">
                  <thead>
                    <tr className="bg-slate-100 text-base sm:text-lg">
                      <th className="px-6 py-4 font-semibold border-y border-slate-200">
                        Nombre
                      </th>
                      <th className="px-6 py-4 font-semibold border-y border-slate-200">
                        Inicio
                  ...
                  <tbody className="text-base sm:text-lg">
                    {items.length === 0 && (
                      <tr>
                        <td
                          colSpan={3}
                          className="px-6 py-12 text-center border-t border-slate-200 text-slate-500"
                        >
                          No hay temporadas.
                        </td>
                      </tr>
